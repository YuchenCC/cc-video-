...
| Scene | 篇章 | Duration | Core concept | Chapter beat | Transition | Status |
|---|---|---:|---|---|---|---|
| scene-001 | 综述 | 28s | 一个组件统一覆盖多个敏感信息出口并记录治理线索 | 无 | wipeSoft | Placeholder |
| scene-002 | 接入篇 | 37.5s | 低侵入接入不同场景并复用统一规则 | 0–2.5s | wipeSoft | Placeholder |
